...
module Nancy
  class Application < Rails::Application
    ...
    config.action_view.javascript_expansions[:defaults] = %w(jquery rails jquery-ui jquery.colorbox jquery.infieldlabel jquery-ui.timepicker jquery-ui.selectmenu modernizr)
